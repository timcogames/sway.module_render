#ifndef SWAY_RENDER_EXPERIENCE_DRAWCOMMANDHANDLER_HPP
#define SWAY_RENDER_EXPERIENCE_DRAWCOMMANDHANDLER_HPP
...
#endif  // SWAY_RENDER_EXPERIENCE_DRAWCOMMANDHANDLER_HPP
