...
void Sprite::setTexture(ImageTypedefs::SharedPtr_t texture, bool recomputeUVRequired) {
...
auto Sprite::getTexture() const -> ImageTypedefs::SharedPtr_t { return texture_; }
