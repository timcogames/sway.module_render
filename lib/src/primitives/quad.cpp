...
Quad::Quad(f32_t width, f32_t height)
  ...
  auto positionChannel = createChannel<math::vec3f_t>(gapi::VertexSemantic_t::Position, 8);
  ...
  auto colorChannel = createChannel<math::vec4f_t>(gapi::VertexSemantic_t::Color, 8);
